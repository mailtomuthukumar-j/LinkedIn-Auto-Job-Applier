...
def main() -> None:
    ...
    try:
        ...
        quotes = choice([
            "Never quit. You're one step closer than before. - Muthukumar", 
            "All the best with your future interviews, you've got this. - Muthukumar", 
            "Keep up with the progress. You got this. - Muthukumar", 
            "If you're tired, learn to take rest but never give up. - Muthukumar",
